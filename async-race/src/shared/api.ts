...
export const getWinners = async ({ page, limit = WINNERS_ON_PAGE, sort, order }: { page: number; limit?: number; sort?: string; order?: string }): Promise<{ items: IWinners[]; count: string }> => {
