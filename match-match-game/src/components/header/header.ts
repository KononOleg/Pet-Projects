...
export class Header extends Basecomponent {
  private static aboutbnt: NavButton = new NavButton("About Game", require("../../assets/icons/question.png"));
  private static settingbnt: NavButton = new NavButton("Game Setting", require("../../assets/icons/settings.png"));
  public static bestscorebnt: NavButton = new NavButton("Best Score", require("../../assets/icons/stars.png"));
  ...
  constructor() {
    ...
    Header.bestscorebnt.element.addEventListener("mousedown", (e) => {
      this.resetActiveButton();
      Routing.getInstance().render(BestScore);
      Header.bestscorebnt.element.classList.add("active");
    });
    Header.settingbnt.element.addEventListener("mousedown", (e) => {
      this.resetActiveButton();
